    ...
    <View style={styles.menu}>
      <View style={styles.details}>
        ...
        <View style={styles.frameParent}>
          ...
          <Pressable
            style={[styles.accountParent, styles.parentFlexBox]}
          ...
          <Pressable
            style={[styles.accountParent, styles.parentFlexBox]}
            onPress={() => navigation.navigate("SELL1")}
          >
            <Text style={styles.home}>new item</Text>
            <Image
              style={styles.vectorIcon}
              contentFit="cover"
              source={require("../assets/vector26.png")}
          ...
          <View style={[styles.accountParent, styles.parentFlexBox]}>
