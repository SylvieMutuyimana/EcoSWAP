...
const ContainerItem3 = memo(() => {
  return (
    <View style={styles.item1}>
      <Image style={styles.biheartFillIcon} contentFit="cover"
        source={require("../../../assets/images/icons/biheartfill.png")}
      />
      <Image style={styles.nokia1Icon} contentFit="cover"
        source={require("../../../assets/images/samples/nokia-11.png")}
      />
      <Text style={styles.description}>
        <Text style={styles.nokiaPhoneCantStart20000}>
          <Text style={styles.nokiaPhoneCant}>
            Nokia phone can{"’"}t start</Text>
