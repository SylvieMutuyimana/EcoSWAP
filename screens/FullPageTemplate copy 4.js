...
const FullPageTemplate = ({ children, green_back, TheFooter, page_name, SecondFooter, SecondHeader, ThirdHeader}) => {
  ...
  return (
    <View style={[pageStyles.fullPage, 
      ...
      green_back ? pageStyles.auth : pageStyles.notAuth
    ]}>
...
const contentStyles = StyleSheet.create({
  ...
  webPage:{
    ...
    minWidth: Width.minPageWidth,
    height: height.full_page,
    paddingBottom: height.footer + 40,
  },
  catPage:{
