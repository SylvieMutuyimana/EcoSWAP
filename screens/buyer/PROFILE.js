...
const BuyerProfile = () => {
  ...
  const linkTypes = [
    { name: 'My Orders', link: 'MyOrders', iconName: "cart" }, 
    { name: 'WishList', link: 'WishList', iconName: 'heart' },
  ...
  const navigateToOrders =(orderType)=>{
    navigation.navigate('MyOrders', {orderType: orderType})
  }
      ...
      <View style={DataOrderTypesStyles.container}>
        {
          orderTypes.map((orderType, index)=>(
            <Pressable style={DataOrderTypesStyles.itemContainer} key={index} onPress={()=>navigateToOrders(orderType.type)}>
    ...
    <ProfileTemplate userType={userType}>
      ...
      <View style={DataOrderTypesStyles.div}>
        <View style={DataOrderTypesStyles.heading}>
          <Text style={DataOrderTypesStyles.headingText}>My Orders</Text>
